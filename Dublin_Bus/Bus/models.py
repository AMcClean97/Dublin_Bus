...
class Stop(models.Model):
    ...
    stop_name = models.CharField(max_length=225)
...
class Shape(models.Model):
    shape_id = models.CharField(max_length=225, primary_key=True)
...
class Trip(models.Model):
    ...
    route_short_name = models.ForeignKey(Route, db_column='route_short_name', on_delete=models.CASCADE)
...
class StopTime(models.Model):
    ...
    stop_headsign = models.CharField(max_length=225)
