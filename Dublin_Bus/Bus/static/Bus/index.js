            ...
            async function processJourney(journey) {
                journey.forEach(async (journey) => {
                    ...
                    if (journey.travel_mode == "TRANSIT" && journey.transit.line.agencies[0].name == "Dublin Bus") {
                        ...
                        journeyDescription = "<i class='fas fa-bus-alt'></i> " + journey.transit.line.short_name + "   |   " + journey.transit.num_stops + ' stops/' + journey.duration.text + ' <i class="fas fa-info-circle d-none d-sm-inline" data-toggle="tooltip" title="Prediction generated by Google" data-placement="auto"></i>';
