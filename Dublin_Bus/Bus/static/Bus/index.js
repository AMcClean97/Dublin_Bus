    ...
    directionsService.route(request, function(response, status) {
        ...
        async function displayRoute(journeyPrediction, predictionSpace, numStops, departureStop, arrivalStop) {
            ...
            if (typeof journeyPrediction == 'string') {
                ...
                pred = numStops.numStops + ' stops/' + predictionMins.toString() + ' mins<i class="fas fa-info-circle d-none d-sm-inline" data-toggle="tooltip" title="Prediction generated by Bustimates" data-placement="auto"></i><br>';
...
//Triggered on pressing Favourite button. Removes or adds current input as favourite
